...
(function () {
  ...
  var I18N = {
    en: {
      ...
      'hero.lede': 'A private company incorporated in Mexico City, since 2010 — a portfolio spanning offshore technology, distilled spirits, agriculture and film.',
      'sector.offshore': 'Ocean Raised Technology', 'sector.tequila': 'Tequila', 'sector.mezcal': 'Mezcal', 'sector.agri': 'Agriculture', 'sector.film': 'Film Production',
      ...
      'group.p1': 'ISURIA is a private company incorporated in Mexico City. Our corporate portfolio spans distilled spirits, film production, agriculture and offshore technology — a wide array of investments held under one roof.',
      ...
      'facts.sectors.k': 'Sectors', 'facts.sectors.v': 'Five verticals',
      'facts.network.k': 'Reach', 'facts.network.v': 'International network',
      'portfolio.eyebrow': 'The Portfolio',
      'portfolio.title': 'Five sectors. <em>One standard.</em>',
      ...
      'offshore.body': 'SIGRICO, S.A.P.I. de C.V. Incorporated to develop and operate offshore mariculture projects in the Mexican Pacific. The company holds an existing Aquaculture Promotion Permit (PAF/DGOPA-018/2023) granted by CONAPESCA for the cultivation of Seriola spp. in federal waters off the western coast of Baja California Sur, and in June 2026 received environmental authorization from SEMARNAT for Proyecto Thalassa — a four-species offshore cage aquaculture operation covering 88.1 hectares — positioning SIGRICO as the first commercial-scale open-ocean mariculture operator on Mexico’s Pacific coast.',
      ...
      'tequila.tag': 'Nº 02 — Tequila', 'tequila.title': 'Tequila <em>Tres Ese</em>',
      ...
      'mezcal.tag': 'Nº 03 — Mezcal', 'mezcal.title': 'Artisanal <em>Mezcal</em>',
      'mezcal.body': 'Two organic mezcal brands. Machetazo offers three expressions—Cupreata from Guerrero, Salmiana from San Luis Potosí, and Espadín from Oaxaca. Mayalen features seven wild agave expressions sourced from Guerrero and Oaxaca.',
      ...
      'agri.tag': 'Nº 04 — Agriculture', 'agri.title': 'Coconut &amp; <em>Land</em>',
      'agri.body': 'Our agricultural platform is anchored by a vertically integrated coconut business in the state of Guerrero, Mexico. Leveraging extensive family-owned plantations, we have secured access to 100,000 coconuts per month, ensuring a reliable and scalable supply of premium raw material. Our initial focus is the production of high-quality organic coconut water, with a strategic roadmap to expand into higher-value products, including virgin coconut oil and other coconut-derived offerings.',
    ...
    es: {
      ...
      'hero.lede': 'Una empresa privada constituida en la Ciudad de México, desde 2010 — un portafolio que abarca tecnología marina, destilados, agricultura y cine.',
      'sector.offshore': 'Tecnología de Cultivo Oceánico', 'sector.tequila': 'Tequila', 'sector.mezcal': 'Mezcal', 'sector.agri': 'Agricultura', 'sector.film': 'Producción de Cine',
      ...
      'group.p1': 'ISURIA es una empresa privada constituida en la Ciudad de México. Nuestro portafolio corporativo abarca destilados, producción de cine, agricultura y tecnología marina — un amplio abanico de inversiones bajo un mismo techo.',
      ...
      'facts.sectors.k': 'Sectores', 'facts.sectors.v': 'Cinco verticales',
      'facts.network.k': 'Alcance', 'facts.network.v': 'Red internacional',
      'portfolio.eyebrow': 'El Portafolio',
      'portfolio.title': 'Cinco sectores. <em>Un estándar.</em>',
      ...
      'offshore.body': 'SIGRICO, S.A.P.I. de C.V. Constituida para desarrollar y operar proyectos de maricultura en mar abierto en el Pacífico mexicano. La empresa cuenta con un Permiso de Fomento Acuícola vigente (PAF/DGOPA-018/2023) otorgado por CONAPESCA para el cultivo de Seriola spp. en aguas federales frente a la costa occidental de Baja California Sur, y en junio de 2026 recibió la autorización ambiental de la SEMARNAT para el Proyecto Thalassa — una operación de acuacultura en jaulas marinas de cuatro especies que abarca 88.1 hectáreas — posicionando a SIGRICO como el primer operador de maricultura en mar abierto a escala comercial en la costa del Pacífico de México.',
      ...
      'tequila.cta': 'Tequila Tres Ese ↗',
      'mezcal.tag': 'Nº 03 — Mezcal', 'mezcal.title': 'Mezcal <em>Artesanal</em>',
      'mezcal.body': 'Dos marcas de mezcal orgánico. Machetazo ofrece tres expresiones—Cupreata de Guerrero, Salmiana de San Luis Potosí y Espadín de Oaxaca. Mayalen presenta siete expresiones de agave silvestre provenientes de Guerrero y Oaxaca.',
      ...
      'agri.tag': 'Nº 04 — Agricultura', 'agri.title': 'Coco y <em>Tierra</em>',
      'agri.body': 'Nuestra plataforma agrícola se sustenta en un negocio de coco verticalmente integrado en el estado de Guerrero, México. Aprovechando extensas plantaciones de propiedad familiar, hemos asegurado el acceso a 100,000 cocos al mes, garantizando un suministro confiable y escalable de materia prima premium. Nuestro enfoque inicial es la producción de agua de coco orgánica de alta calidad, con una hoja de ruta estratégica para expandirnos hacia productos de mayor valor, incluyendo aceite de coco virgen y otras ofertas derivadas del coco.',
